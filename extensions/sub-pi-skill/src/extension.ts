...
const applyThinkingOverride = (ctx: ExtensionContext, thinkingLevel: string | undefined): void => {
...
const assertSubPiToolRegistered = (pi: ExtensionAPI, ctx: ExtensionContext): void => {
