...
const parityCases: BashParityCase[] = [
  ...
  // Blocked by https://github.com/earendil-works/pi/issues/4818
  {
  ...
  // Blocked by https://github.com/earendil-works/pi/issues/4818
  // Blocked by https://github.com/earendil-works/pi/issues/4819
  {
...
const activeParityCases = parityCases.filter((testCase) => !testCase.skip);
const skippedParityCases = parityCases.filter((testCase) => testCase.skip);
